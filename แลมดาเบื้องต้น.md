# λ ใน Java 8
แลมดาใน Java 8 สามารถเขียนได้เช่น (source code ทั้งหมดอยู่ใน repository [ดาวโหลด](https://github.com/Charnnarong/Lambda-Java-8/blob/Lambda/src/sourceCode.zip))
